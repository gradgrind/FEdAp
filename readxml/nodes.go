...
type Lesson struct {
	...
	//EpochPlan    Ref `xml:",attr"` // What is this? Not relevant?
	// If this entry is not empty, the Course field may be an EpochPlanCourse ... or nothing!
	//EpochPlanGrade Ref `xml:",attr"` // What is this?
}

func (n *Lesson) IdStr() Ref {
	return n.Id
}
